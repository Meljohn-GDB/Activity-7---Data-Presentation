...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 Tuition Assistance Database</h1>
        ...
        <div class="card">
            <h2>1️⃣ Top 10 Departments by Enrollment</h2>
            <div class="explanation">
        ...
        <div class="card">
            <h2>2️⃣ Distribution by Degree Type</h2>
            <div class="explanation">
        ...
        <div class="card">
            <h2>3️⃣ Top 15 Schools/Universities</h2>
            <div class="explanation">
        ...
        <div class="card">
            <h2>4️⃣ Top 15 Major Fields of Study</h2>
            <div class="explanation">
                <strong>Visualization Type:</strong> Horizontal Bar Chart<br>
        ...
        <div class="card">
            <h2>📋 Complete Department Breakdown</h2>
            <div class="explanation">
        ...
        <div class="card">
            <h2>📋 Top 20 Schools Summary Table</h2>
            <div class="explanation">
        ...
        <!-- Cross-tabulation -->
        <div class="card">
            <h2>🔄 Department × Degree Type Cross-Tabulation (Top 5 Departments)</h2>
            <div class="explanation">
        ...
        <div class="header" style="margin-top: 30px;">
            <p style="color: #666;">
                <strong>Activity 7 – Data Presentation</strong><br>
